...
public class Board extends JPanel implements ActionListener {
    ...
    public Board() {
        ...
        ImageIcon green = new ImageIcon(this.getClass().getResource("dot.png"));
        zielona = green.getImage();

        ImageIcon blue = new ImageIcon(this.getClass().getResource("apple.png"));
        cel = blue.getImage();

        ImageIcon red = new ImageIcon(this.getClass().getResource("head.png"));
    ...
    public void paint(Graphics g) {
        ...
        if (wPolu) {
            ...
            g.drawImage(cel, cel_x, cel_y, this);

            for (int z = 0; z < kropeczki; z++) {
                if (z == 0)  
                    g.drawImage(czerwona, x[z], y[z], this);
                else 
                    g.drawImage(zielona, x[z], y[z], this);
            }
